...
To get started, clone the GitHub [repository](https://github.com/ky7333/unraid-ansible) containing the Dockerfile and
scripts:

```bash
git clone https://github.com/ky7333/unraid-ansible
cd unraid-ansible
```
...
```bash
docker build -t my-unraid-ansible:latest .
```
