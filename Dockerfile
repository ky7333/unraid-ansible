...
RUN apt-get update \
    && apt-get install -y iproute2 iputils-ping libguestfs-tools linux-image-generic openssh-server python3-guestfs python3-libvirt python3-lxml telnet virtinst\
    && apt-get clean \
